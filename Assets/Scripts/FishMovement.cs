...
public class FishMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Check for jump input and whether the player is not currently jumping
        // Attempting to jump while underwater sends you back to the surface quickly, which isn't
        // *technically* intentional, but I kind of like it
